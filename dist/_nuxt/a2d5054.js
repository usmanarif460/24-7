  ...
  [24, 5, 6, 9, 11],
  {
    ...
    324: function (t, e, l) {
      ...
      content.__esModule && (content = content.default),
        "string" == typeof content && (content = [[t.i, content, ""]]),
        content.locals && (t.exports = content.locals);
      (0, l(85).default)("091bbd20", content, !0, { sourceMap: !1 });
    },
    339: function (t, e, l) {
      "use strict";
      l(324);
    ...
    340: function (t, e, l) {
      ...
      n.push([
        t.i,
        ".bg-design[data-v-6cabc0b5]{-webkit-backdrop-filter:saturate(200%) blur(25px);backdrop-filter:saturate(200%) blur(25px)}",
        "",
      ]),
        (n.locals = {}),
        (t.exports = n);
          ...
          methods: {
            loginUser: function () {
              ...
              this.$fire.auth
                ...
                .then(function () {
                  (t.email = ""), (t.password = ""), t.$router.push("/");
                })
                .catch(function (t) {
                  return alert(t);
                });
            ...
            googleSignIn: function () {
              var t = this,
                e = new this.$fireModule.auth.GoogleAuthProvider();
              this.$fire.auth
                .signInWithPopup(e)
                .then(function () {
                  t.$router.push("/");
          ...
          function () {
            ...
            return e(
              ...
              [
                ...
                e("top-svg"),
                t._v(" "),
                e("div", { staticClass: "bg-design w-full pt-2 px-12" }, [
                  e("div", { staticClass: "mt-[-400px] max-w-2xl mx-auto" }, [
                    t._m(0),
                    t._v(" "),
                    e(
                      "div",
                      {
                        staticClass:
                          "bg-white shadow-2xl rounded px-8 pt-6 pb-8 mb-16",
                      },
                      [
                        e(
                          "form",
                          {
                            ...
                            on: {
                              submit: function (e) {
                                return (
                                  e.preventDefault(),
                                  t.loginUser.apply(null, arguments)
                                );
                              },
                            },
                          },
                              ...
                              e(
                                ...
                                [
                                  ...
                                  e("input", {
                                    ...
                                    staticClass:
                                      "block pr-10 shadow appearance-none border-2 border-orange-100 rounded w-full py-2 px-4 text-gray-700 mb-3 leading-tight focus:outline-none focus:bg-white focus:border-blue-600 transition duration-500 ease-in-out",
                                    attrs: {
                                      id: "email",
                                      type: "email",
                              ...
                              e(
                                ...
                                [
                                  ...
                                  e(
                                    ...
                                    {
                                      staticClass:
                                        "font-bold text-lg text-blue-500 hover:text-blue-600 italic pl-3",
                                      attrs: { to: "/signup" },
                                    },
                                    [
                                      t._v(
          ...
          [
            function () {
              ...
              return t(
                ...
                {
                  staticClass:
                    "mt-24 mb-2 bg-white flex justify-center rounded",
                },
                [
                  t(
                    "span",
                    { staticClass: "text-3xl text-blue-500 font-bold p-3" },
                    [this._v("\n            Sign-in\n          ")]
                  ),
                ]
              );
            ...
            function () {
              ...
              return e(
                ...
                [
                  e("span", { staticClass: "text-red-800" }, [t._v(" *")]),
                  t._v("\n                Email Address ( "),
                  e("strong", { staticClass: "text-red-500 text-sm italic" }, [
                    t._v("email is required )"),
                  ]),
                ]
              );
            },
            function () {
              ...
              return e(
                ...
                [
                  e("span", { staticClass: "text-red-500" }, [t._v(" *")]),
                  t._v("\n                Password\n              "),
                ]
              );
            },
            function () {
              var t = this,
                e = t._self._c;
              return e("div", { staticClass: "mb-6" }, [
                e("div", { staticClass: "flex items-center justify-between" }, [
                  e("div", [
                    e(
                      "label",
                      {
                  ...
                  e("div", [
                    e(
                      ...
                      {
                        staticClass:
                          "font-bold text-sm text-blue-700 hover:text-blue-900",
            ...
            function () {
              var t = this._self._c;
              return t("div", { staticClass: "mb-4 text-center" }, [
                t(
                  "button",
                  {
                    staticClass:
                      "transition duration-500 bg-blue-600 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline",
                    attrs: { type: "submit" },
                  },
                  [this._v("\n                Login\n              ")]
                ),
