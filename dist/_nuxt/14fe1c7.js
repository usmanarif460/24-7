(window.webpackJsonp = window.webpackJsonp || []).push([
  [25, 5, 6, 8, 9, 10, 11],
  {
    ...
    319: function (t, e, l) {
      ...
      l.r(e);
      l(43);
      var n = { props: { product: { type: Object, required: !0 } } },
        r = l(48),
        component = Object(r.a)(
          n,
          function () {
            ...
            return e(
              ...
              [
                e(
                  "nuxt-link",
                  { attrs: { to: "/products/".concat(t.product.id) } },
                  [
                    e(
                      "div",
                      {
                        staticClass:
                          "overflow-hidden text-center rounded-md border-2 border-blue-500",
                      },
                      [
                        e("div", { staticClass: "hover:scale-110" }, [
                          e("img", {
                            staticClass: "w-64 h-48 mx-auto",
                            attrs: {
                        ...
                        t._v(" "),
                        e("div", { staticClass: "p-4" }, [
                          e("p", [t._v(t._s(t.product.name))]),
                          t._v(" "),
                          e("p", { staticClass: "font-bold my-3" }, [
                            t._v("Rs " + t._s(t.product.price) + ".00"),
                          ]),
                          t._v(" "),
                          e("div", [
                            e(
                              ...
                              {
                                staticClass:
                                  "text-white bg-blue-500 hover:bg-blue-600 px-3 py-2 w-full rounded-full hover:text-white",
                              },
                              [t._v("ADD\n            TO CART")]
                            ),
                          ]),
    ...
    366: function (t, e, l) {
      ...
      var n = l(30),
        r = l(3);
      l(22), l(11), l(36), l(44), l(35), l(45), l(66), l(67);
      function o(object, t) {
      ...
      var d = {
          components: { theProduct: l(319).default },
          data: function () {
          ...
          function () {
            ...
            return e(
              ...
              [
                ...
                e("top-header", [
                  t._v("Get your All "),
                  e("span", { staticClass: "text-red-800" }, [
                    t._v("Medicines+"),
                  ]),
                  e("br"),
                  t._v("From Here"),
                ...
                e(
                  ...
                  {
                    staticClass:
                      "mt-[180px] mb-24 mx-auto w-11/12 grid grid-cols-1 md:grid-cols-3 lg:grid-col-4 xl:grid-cols-5 2xl:grid-cols-6 gap-10",
                  },
                  t._l(t.products, function (t, l) {
                    return e("the-product", {
                      key: "".concat(t.id, "-product-").concat(l),
                      attrs: { product: t },
                    });
                  }),
                  1
