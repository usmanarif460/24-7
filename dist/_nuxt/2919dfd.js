  ...
  [27, 5, 6, 9, 11],
  {
    ...
    325: function (t, e, l) {
      ...
      content.__esModule && (content = content.default),
        "string" == typeof content && (content = [[t.i, content, ""]]),
        content.locals && (t.exports = content.locals);
      (0, l(85).default)("6b145b17", content, !0, { sourceMap: !1 });
    },
    341: function (t, e, l) {
      "use strict";
      l(325);
    ...
    342: function (t, e, l) {
      ...
      r.push([
        t.i,
        ".bg-design[data-v-2121762b]{-webkit-backdrop-filter:saturate(200%) blur(25px);backdrop-filter:saturate(200%) blur(25px)}",
        "",
      ]),
        (r.locals = {}),
        (t.exports = r);
                      ...
                      [
                        e(
                          "form",
                          {
                            ...
                            on: {
                              submit: function (e) {
                                return (
                                  e.preventDefault(),
                                  t.registerUser.apply(null, arguments)
                                );
                              },
                            },
                          },
                          [
                            e(
                              "div",
                              { staticClass: "md:grid grid-cols-2 gap-8" },
                              [
