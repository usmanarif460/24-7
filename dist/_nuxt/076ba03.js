  ...
  [21, 5, 6, 9, 10, 11],
  {
    ...
    308: function (t, e, l) {
      ...
      content.__esModule && (content = content.default),
        "string" == typeof content && (content = [[t.i, content, ""]]),
        content.locals && (t.exports = content.locals);
      (0, l(85).default)("602f3f64", content, !0, { sourceMap: !1 });
    },
    309: function (t, e, l) {
      "use strict";
      l.r(e);
    ...
    376: function (t, e, l) {
        ...
        component = Object(n.a)(
          ...
          [
            function () {
              ...
              return e(
                "div",
                { staticClass: "mt-48 container my-24 mx-auto md:px-6" },
                [
                  e("section", { staticClass: "mt-24" }, [
                    e("div", { staticClass: "py-12 md:px-12" }, [
                      e("div", { staticClass: "container mx-auto xl:px-32" }, [
                        e(
                          "div",
                          { staticClass: "grid items-center lg:grid-cols-2" },
                          [
                            e(
                              "div",
                              { staticClass: "mb-12 md:mt-12 lg:mt-0 lg:mb-0" },
                              [
                                e(
                                  "div",
                                  {
                                    staticClass:
                                      "relative z-[10] block rounded-lg bg-white px-6 py-12 md:px-12 lg:-mr-14 shadow-lg",
                                  },
                                  [
                                    e(
                                      "h2",
                                      {
                                        staticClass:
                                          "bg-blue-500 animate-pulse rounded-lg p-2 mb-12 text-3xl font-bold text-center text-white",
                                      },
                                      [t._v("Contact us")]
                                    ),
                                    t._v(" "),
                                    e("form", [
                                      e("div", { staticClass: "mb-8" }, [
                                        ...
                                        e(
                                          ...
                                          [
                                            e("input", {
                                              staticClass:
                                                "block pr-10 shadow appearance-none border-2 border-blue-200 rounded w-full py-2 px-4 text-gray-700 mb-3 leading-tight focus:outline-none focus:bg-white focus:border-blue-600 transition duration-500 ease-in-out",
                                              attrs: {
                                                type: "text",
                                                placeholder:
                                      ...
                                      e("div", { staticClass: "mb-8" }, [
                                        ...
                                        e(
                                          ...
                                          [
                                            e("textarea", {
                                              staticClass:
                                                "block pr-10 shadow appearance-none border-2 border-blue-200 rounded w-full h-24 py-2 px-4 text-gray-700 mb-3 leading-tight focus:outline-none focus:bg-white focus:border-blue-600 transition duration-500 ease-in-out",
                                              attrs: {
                                                type: "text",
                                                placeholder:
                                                  "Enter Your Message",
                                      ...
                                      e(
                                        ...
                                        {
                                          staticClass:
                                            "block rounded border border-blue-500 px-6 pt-2.5 pb-2 text-md font-bold uppercase leading-normal text-blue-500 shadow-[0_4px_9px_-4px_#3b71ca] transition duration-150 ease-in-out hover:bg-blue-600 hover:text-white",
                                          attrs: {
                                            type: "button",
                                            "data-te-ripple-init": "",
                            ...
                            e(
                              ...
                              {
                                staticClass:
                                  "md:mb-12 lg:mb-0 hidden lg:block rotate-[5deg]",
                              },
                              [
                                e(
                                  "div",
                                  {
                                    staticClass:
                                      "relative h-[700px] rounded-lg shadow-lg dark:shadow-black/20",
                                  },
                                  [
                                    e("img", {
                                      staticClass:
      ...
      installComponents(component, {
        ...
        TopSvg: l(309).default,
        TopHeader: l(315).default,
