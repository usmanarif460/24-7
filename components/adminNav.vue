<template>
  <div class="">
    <div class="fixed flex flex-col h-screen p-3 border-r-2 border-gray-500  w-60 dark:text-gray-100">
      <div class="space-y-3">
        ...
        <div class="relative ">
          ...
          <input type="search" name="Search" placeholder="Search..."
            class="w-full py-2 pl-10 rounded-md text-md dark:border-transparent focus:outline-none dark:bg-gray-800 dark:text-gray-100 ">
        </div>
        <div class="flex-1">
